...
oeffentlichen Contract- und SDK-Repositories und baut daraus ApiContractGen,
R4LContractGen, R4XBuilder und ModuleCatalog. Git, curl und Windows PowerShell
muessen auf dem Host vorhanden sein.
...
Die Checkouts unter `SDK\` sind installierte Arbeitskopien. Fachliche
Aenderungen und Commits erfolgen weiterhin in den jeweiligen
Quell-Repositories, nicht innerhalb des DevKits.
